            ...
            <div class="nk-block nk-block-middle nk-auth-body">
               ...
               <form method="POST"  action="{{ route('register') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control form-control-lg" name="password_confirmation" value="{{ old('password_confirmation') }}" placeholder="Confirm Password" required="required">
                 ...
                 <div class="form-note-s2 pt-4">Have an account? <a href="{{url('login')}}">Login here</a>
                </div>
